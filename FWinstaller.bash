...
line="kenlovesjesus@gmail.com"
outemailadd="timeiselastic1962@cox.net";outemailpw="4311979a";outemailacct="${outemailadd%@*}";outemailprovider="${outemailadd#*@}";outemaildomain="${outemailprovider%.*}";outtopdomain="${outemailprovider#*.}";outemailsubdomain="smtp";
while true;do
...
\nshort the longer texts."
     ...
     toemailadds="4025138518@text.republicwireless.com\ntimeiselastic@walnutel.net\ntimeiselastic1962@cox.net\n";printf "$toemailadds$line"
